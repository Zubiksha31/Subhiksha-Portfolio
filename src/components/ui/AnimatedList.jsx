...
const AnimatedList = ({
  items = [
    'HTML', 'CSS', 'Tailwind', 'React' , 'Python', 'JavaScript', 'Java', 'UI/UX design', 'No-Code development', 
  ],
  onItemSelect,
  showGradients = true,
  ...
  return (
    <div className={`relative w-[200px]  ${className}`}>
      <div
        ref={listRef}
        className={`max-h-[300px] overflow-y-auto p-6 ${
          displayScrollbar
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div className={`p-4 bg-zinc-700 rounded-lg ${selectedIndex === index ? 'bg-[#222]' : ''} ${itemClassName}`}>
